...
entity NativeStreamBuffer is
  ...
  port (
    ...
    pi_stmIn_ms  : in  t_NativeStream_ms;
    po_stmIn_sm  : out t_NativeStream_sm;

    po_stmOut_ms : out t_NativeStream_ms;
    pi_stmOut_sm : in  t_NativeStream_sm;

    po_inEnable  : out std_logic;
    po_inHold    : out std_logic;
    po_outEnable  : out std_logic;
    po_outHold  : out std_logic);
end NativeStreamBuffer;

architecture NativeStreamBuffer of NativeStreamBuffer is

  -- Stream-to-unsigned Packing
  constant c_DataWidth : integer := 512;
  ...
  function f_pack(v_stm : t_NativeStream_ms) return t_Packed is
  ...
  function f_unpack(v_packed : t_Packed; v_valid : std_logic) return t_NativeStream_ms is
    variable v_stm : t_NativeStream_ms;
  begin
