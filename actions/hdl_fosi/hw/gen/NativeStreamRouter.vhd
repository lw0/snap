...
entity NativeStreamRouter is
  ...
  port (
    ...
    pi_stmIn_ms  : in  t_NativeStream_v_ms(g_InPortCount-1 downto 0);
    po_stmIn_sm  : out t_NativeStream_v_sm(g_InPortCount-1 downto 0);

    po_stmOut_ms : out t_NativeStream_v_ms(g_OutPortCount-1 downto 0);
    pi_stmOut_sm : in  t_NativeStream_v_ms(g_OutPortCount-1 downto 0);
...
architecture NativeStreamRouter of NativeStreamRouter is
  ...
  signal s_inPorts_ms     : t_NativeStream_v_ms(g_InPortCount-1 downto 0);
  signal s_inPorts_sm     : t_NativeStream_v_sm(g_InPortCount-1 downto 0);
  signal s_outPorts_ms    : t_NativeStream_v_ms(g_OutPortCount-1 downto 0);
  signal s_outPorts_sm    : t_NativeStream_v_sm(g_OutPortCount-1 downto 0);
